...
import {FormControl, FormHelperText, Input, InputAdornment, InputLabel, Select, TextField} from "@mui/material";
...
export default function StepOperationGeneralInfo(props) {
    ...
    const AccountField = () => {
        return <FormControl fullWidth>
            ...
            {props.errors.account.length > 0 &&
                <FormHelperText error={true}>{props.errors.account.join('. ')}</FormHelperText>}
        </FormControl>
    }
    ...
    const CategoryField = () => {
        return <FormControl fullWidth>
            ...
            {props.errors.category.length > 0 &&
                <FormHelperText error={true}>{props.errors.category.join('. ')}</FormHelperText>}
        </FormControl>
    }
                ...
                <Grid item xs={8} sm={4}>
                    <FormControl fullWidth>
                        ...
                        <Input
                            ...
                            value={props.amount}
                        />
                        {props.errors.amount.length > 0 &&
                            <FormHelperText error={true}>{props.errors.amount.join('. ')}</FormHelperText>}
                    </FormControl>
                </Grid>
            </Grid>
        </React.Fragment>
